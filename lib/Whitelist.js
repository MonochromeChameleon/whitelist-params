...
function Whitelist () {
  ...
  var handler = function (req, res, next) {
    ...
    var hasAllRequiredProps = true
    var ii = -1
    while (++ii < parameters.required.length && hasAllRequiredProps) {
      hasAllRequiredProps = reqParams.hasOwnProperty(parameters.required[ii])
    }
  ...
  functionNames.forEach(function (func) {
    handler[func] = function () {
      ...
      validParameterNames = functionNames.reduce(function (acc, func) {
